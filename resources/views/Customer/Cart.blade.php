               ...
               <a href="{{ route('index') }}" class="btn btn-lg btn-primary aa-cart-view-btn" style="border-radius:0px; padding:13px; float:right; margin-bottom:20px"></i>Add More Product&nbsp<i class="fa fa-smile-o fa-lg" aria-hidden="true"></i></a>
                  <table class="table">
                    ...
                    <tbody>
                        ...
                        {{$item->id}}
                        <td><a data-id={{ $item->id }} id="do" class="remove do" href="#"><fa class="fa fa-close"></fa></a></td>
...
$(document).ready(function(){
    $(".quantity").on('change keyup', function() {
        ...
        //alert(cartId)
        $.ajax({
          //url: `https://dailyshop.thevoice24.com/api/update/${userName}/${cartId}/${update}`,
    ...
    $(".do").click(function(){    
      ...
      $.ajax({
        ...
        url:`http://127.0.0.1:8000/api/deleteCart/${cartId}`,
        //url:`https://dailyshop.thevoice24.com/api/deleteCart/${cartId}`,
        method:"Delete",
        complete:function(xmlHttp, status){
